...
(nejmenší \emph{hypervolume contribution}). Z~teoretického hlediska nejlépe podložený přístup (maximalizace hypervolume implikuje Pareto-optimalitu), ale výpočet
